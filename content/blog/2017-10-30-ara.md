...
![ARA Dashboard](/images/ara/dashboard-basic.png){: class="bigger-image" }
...
![Dashboard record](/images/ara/dashboard-record.png){: class="bigger-image" }
...
![Search elastic](/images/ara/search-elastic.png){: class="bigger-image" }
<figcaption class="caption">Full text search</figcaption>

![Search failed](/images/ara/search-failed.png){: class="bigger-image" }
