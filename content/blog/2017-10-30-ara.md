...
description: "Recording and visualising Ansible playbook runs with ARA (Ansible Run Analysis), including a systemd service to keep it running."
...
{{< figure src="/images/ara/ara-callback.png" alt="ARA Callback" caption="ARA Dashboard" >}}
