...
description: "Enforcing strict EC2 tagging policies with Python and AWS Lambda, CloudTrail, SNS and S3, a practical intro to serverless and FaaS."
...
{{< figure src="/images/broom/broom.png" alt="Broom" caption="Keep your stuff clean!" class="center-image" width="140px" >}}
...
what Kubernetes is, or how it works, you can check out [my Kubernetes series][2].
...
{{< figure src="/images/broom/containers.jpg" alt="Broom" caption="Get the hint?" >}}
...
![AWS CloudTrail Console](/images/broom/cloudtrail-console.jpg)
...
{{< figure src="/images/broom/sns-topic.png" alt="SNS console" caption="Console version" >}}
...
[boto3][4] for Broom. You can see [the source code][5].
...
{{< figure src="/images/broom/lambda-trigger.png" alt="Lambda trigger" caption="Trigger happy" >}}

Then name your function, select the runtime, and include your code with it:

![Lambda trigger](/images/broom/lambda-function.png)
...
![Lambda role](/images/broom/lambda-role.png)
...
{{< figure src="/images/broom/sns-mail.png" alt="SNS notification mail" caption="Whoops, sorry!" >}}

## Final thoughts

You can see [all the Lambda limits][7]. For this use case, none of them are actually blocking.
...
[1]: https://fission.io/
[2]: /blog/how-does-it-work-kubernetes-episode-1-kubernetes-general-architecture/
[3]: https://aws.amazon.com/cloudtrail/faqs/
[4]: https://docs.aws.amazon.com/boto3/latest/
[5]: https://github.com/sebiwi/broom/blob/master/broom.py
[6]: https://docs.aws.amazon.com/AmazonS3/latest/userguide/notification-content-structure.html
[7]: https://docs.aws.amazon.com/lambda/latest/dg/gettingstarted-limits.html
[8]: https://www.serverless.com/
[9]: https://github.com/aws/chalice
[10]: https://www.serverless.com/framework/docs/providers/aws/guide/resources#configuration
